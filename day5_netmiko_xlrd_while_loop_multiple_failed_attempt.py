...
# Flag variable to track success status
...
while end < 5:
    ...
    for singleindex333 in range(1, sheet333.nrows):
        ...
        try:
            ...
            ciscodeviceinfo333 = {
                ...
                "password": input(deviceip333 + " Enter the credential: ")
            }

            # Connect to device via SSH
            ssh333 = ConnectHandler(**ciscodeviceinfo333)
            sshpromt333 = ssh333.find_prompt()
            print(sshpromt333)
            if ">" in sshpromt333 or "#" in sshpromt333:
                ...
                for sincli333 in listshowcli333:
                    ...
                    with open(r"C:\Users\Rohan\Documents\show_cli_backup_" + deviceip333 + "-" + newhost333 + "-" + customizedate333 + ".txt", "a") as backup3334:
                        ...
                        backup3334.write("#" * 150 + "\n")
                ssh333.disconnect()  # Disconnect from device
                print("Disconnected from " + deviceip333)
                print("#" * 50)
                # Set job_successful to True once job is successful
                job_successful = True
    ...
    # Check if job is successful, then break out of the while loop
    if job_successful:
        break
